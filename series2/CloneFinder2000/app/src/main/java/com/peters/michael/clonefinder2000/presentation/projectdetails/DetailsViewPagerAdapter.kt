...
class DetailsViewPagerAdapter(private val context: Context,
    ...
    var onCloneTypeClicked: ((CloneType) -> Unit)? = null
    ...
    private fun createSummaryView(container: ViewGroup): View {
        return LayoutInflater.from(context).inflate(R.layout.layout_project_summary_view, container, false).apply {
            projectDetails?.let {
                ...
                projectSummaryType1.setOnClickListener { onCloneTypeClicked?.invoke(CloneType.TYPE_1) }
                ...
                projectSummaryType2.setOnClickListener { onCloneTypeClicked?.invoke(CloneType.TYPE_2) }
                ...
                projectSummaryType3.setOnClickListener { onCloneTypeClicked?.invoke(CloneType.TYPE_3) }
            }
        }
    }
